...
struct WorkingParam {
    ...
    WorkingParam(double a1 = 0, double a2 = 0, double an = 0) { Set(a1, a2, an); }
...
public:
    ...
    // 随机访存并行
    void GenerateSortedRuns(const char *file, const std::vector<SequenceMeta> &meta_table, size_t chunk_size_bytes,
